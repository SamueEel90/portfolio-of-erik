    ...
    <div className="w-full">
      <footer className="max-w-7xl mx-auto px-6 py-8 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col md:flex-row items-center md:justify-between w-full gap-6 md:gap-0">
          {/* Logo */}
          <Link href="/" className="text-5xl md:text-6xl font-monotype-corsiva cursor-pointer text-primary hover:text-light-gray transition-colors">
          <h1 className="text-5xl md:text-6xl font-monotype-corsiva cursor-pointer text-white glow-light-purple hover:text-light-gray transition-colors">
            Erik Gunár
          </h1>
          </Link>

          {/* Navigation */}
          <nav className="flex flex-wrap justify-center md:justify-end gap-4 md:gap-10 text-white glow-purple font-medium text-lg md:text-xl">
        ...
        <p className="text-primary font-monotype-corsiva text-xl md:text-2xl mt-8 md:mt-12">
