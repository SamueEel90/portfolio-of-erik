  ...
  return (
    <div className="w-full flex flex-col p-4 px-6 md:px-25 space-y-12 text-center ">
      <section className="space-y-4  mx-auto md:mx-0">
        <p className="text-3xl text-gray-600 lg:text-left lg:max-w-2xl">
      ...
      <section className="space-y-4  mx-auto md:mx-0">
        <p className="text-gray-600 text-2xl leading-relaxed lg:text-left lg:max-w-2xl">
      ...
      <div className="pt-4 flex flex-col items-center space-y-4">
        <a
          href="/contact"
          className="inline-block px-10 w-[250px] py-3 text-lg font-medium border border-gray-300 rounded-full text-primary hover:bg-gray-900 hover:text-white transition-all duration-300"
        >
          Kontaktujte ma
        </a>
        <SocialIconsMobile />
