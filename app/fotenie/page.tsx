...
const PhotoPage: React.FC = () => {
  ...
  return (
    <main className="sm:max-w-10/12 w-full mx-auto px-4 mt-20  my-16">
      <h2 className="text-3xl md:text-5xl text-primary text-center mb-8">
        Venujem sa fotografovaniu:
      </h2>
      <p className="text-2xl text-center text-light-gray">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam dicta dolorem maxime quas velit, inventore, porro amet iusto sint quia eum quos , <br /> asperiores sed doloribus? Consectetur quidem autem exercitationem sed.</p>
